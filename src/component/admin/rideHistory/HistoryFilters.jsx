...
const HistoryFilters = ({
    ...
    statusFilter,
    setStatusFilter,
    onExport // Naya prop export logic ke liye
}) => {
    return (
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-4 border border-slate-200 rounded-xl shadow-sm">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
                <button
                    onClick={onExport} // Click hone par CSV download trigger hoga
                    className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 bg-slate-900 text-white rounded-lg text-sm font-bold hover:bg-slate-800 transition-all shadow-sm active:scale-95"
                >
